package se.cambio.hackme.config.social;

import se.cambio.hackme.repository.SocialUserConnectionRepository;
import se.cambio.hackme.repository.CustomSocialUsersConnectionRepository;
import se.cambio.hackme.security.social.CustomSignInAdapter;
